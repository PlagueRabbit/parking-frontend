...
export default function ParkingLotDashboard() {
  ...
  const baseURL = "https://privately-firm-cat.ngrok-free.app" // ngrok 주소
  ...
  useEffect(() => {
    if (selectedLot) {
      axios
        .get<ParkingData>(`${baseURL}/static/parking_${selectedLot.id}.json`, {
          headers: {
            "ngrok-skip-browser-warning": "true",
          },
        })
        ...
        .catch((err) => {
          ...
          setParkingData({ available_spaces: 0, long_parked: 0, total_spaces: 0 })
        })
    }
  }, [selectedLot])
      ...
      <div className="layout">
        ...
        <div className="main-content">
          ...
          <div className="image-wrapper">
            {selectedLot && (
              <img
                src={`${baseURL}/static/predicted${selectedLot.id}.jpg`}
                alt="주차장 이미지"
